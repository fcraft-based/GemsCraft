    ...
    sealed class WorldListEntry : ICloneable
    {
        ...
        public string Name
        {
            ...
            set
            {
                ...
                else if (!value.Equals(name, StringComparison.OrdinalIgnoreCase) && GemsCraft.Display.ConfigGUI.GUI.BasicConfig.MainForm.IsWorldNameTaken(value))
                {
                ...
                else
                {
                    ...
                    if (oldName != null)
                    {
                        GemsCraft.Display.ConfigGUI.GUI.BasicConfig.MainForm.HandleWorldRename(oldName, name);
                    }
                }
            }
        }
        ...
        {
            get => accessSecurity.HasRankRestriction ? GemsCraft.Display.ConfigGUI.GUI.BasicConfig.MainForm.ToComboBoxOption(accessSecurity.MinRank) : DefaultRankOption;
            set
            {
        ...
        public string BuildPermission
        {
            get
            {
                ...
                {
                    return GemsCraft.Display.ConfigGUI.GUI.BasicConfig.MainForm.ToComboBoxOption(buildSecurity.MinRank);
                }
                else
                {
            ...
            set
            {
                foreach (Rank rank in RankManager.Ranks)
                {
                    if (GemsCraft.Display.ConfigGUI.GUI.BasicConfig.MainForm.ToComboBoxOption(rank) == value)
                    {

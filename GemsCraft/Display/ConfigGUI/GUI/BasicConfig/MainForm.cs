...
namespace GemsCraft.Display.ConfigGUI.GUI.BasicConfig {
    public sealed partial class MainForm : Form {
        static GemsCraft.Display.ConfigGUI.GUI.BasicConfig.MainForm instance;
        readonly Font bold;
        Rank selectedRank;
        ...
        void Init( object sender, EventArgs e ) {
            ...
            Server.InitLibrary(Environment.GetCommandLineArgs(), false);
...
Your rank is {RANK}&S. Type &H/Help&S for help." );
        ...
        void SelectRank( Rank rank ) {
            ...
            ApplyColor( bColorRank, Utils.Color.ParseToIndex( rank.Color ) );
        ...
        void RebuildRankList() {
            ...
            foreach( Rank rank in RankManager.Ranks ) {
                vRanks.Items.Add( GemsCraft.Display.ConfigGUI.GUI.BasicConfig.MainForm.ToComboBoxOption( rank ) );
            }
        ...
        static void FillRankList( [NotNull] ComboBox box, string firstItem ) {
            ...
            foreach( Rank rank in RankManager.Ranks ) {
                box.Items.Add( GemsCraft.Display.ConfigGUI.GUI.BasicConfig.MainForm.ToComboBoxOption(rank) );
            }
        }
        ...
        private void bAddRank_Click( object sender, EventArgs e ) {
            ...
            rankNameList.Insert( rank.Index + 1, GemsCraft.Display.ConfigGUI.GUI.BasicConfig.MainForm.ToComboBoxOption(rank) );
        }
        ...
        private void bDeleteRank_Click( object sender, EventArgs e ) {
            if( vRanks.SelectedItem != null ) {
                ...
                string worldUpdates = "";
                foreach( WorldListEntry world in Worlds ) {
                    if( world.AccessPermission == GemsCraft.Display.ConfigGUI.GUI.BasicConfig.MainForm.ToComboBoxOption(deletedRank) ) {
                        world.AccessPermission = GemsCraft.Display.ConfigGUI.GUI.BasicConfig.MainForm.ToComboBoxOption(replacementRank);
                        worldUpdates += " - " + world.Name + ": access permission changed to " + replacementRank.Name + Environment.NewLine;
                    }
                    if( world.BuildPermission == GemsCraft.Display.ConfigGUI.GUI.BasicConfig.MainForm.ToComboBoxOption(deletedRank) ) {
                        world.BuildPermission = GemsCraft.Display.ConfigGUI.GUI.BasicConfig.MainForm.ToComboBoxOption(replacementRank);
        ...
        private void tPrefix_Validating( object sender, CancelEventArgs e ) {
            ...
            string oldName = GemsCraft.Display.ConfigGUI.GUI.BasicConfig.MainForm.ToComboBoxOption(selectedRank);
        ...
        private void bRaiseRank_Click( object sender, EventArgs e ) {
            ...
            if( RankManager.RaiseRank( selectedRank ) ) {
                RebuildRankList();
                rankNameList.Insert( selectedRank.Index + 1, GemsCraft.Display.ConfigGUI.GUI.BasicConfig.MainForm.ToComboBoxOption(selectedRank) );
        ...
        private void bLowerRank_Click( object sender, EventArgs e ) {
            ...
            if( RankManager.LowerRank( selectedRank ) ) {
                RebuildRankList();
                rankNameList.Insert( selectedRank.Index + 2, GemsCraft.Display.ConfigGUI.GUI.BasicConfig.MainForm.ToComboBoxOption(selectedRank) );
        ...
        private void chkEnableMessageTypes_CheckedChanged(object sender, EventArgs e)
        {
            foreach (Control c in gboMessageType.Controls)
            {
                ...
                if (c.GetType().ToString() == "CheckBox")
                {

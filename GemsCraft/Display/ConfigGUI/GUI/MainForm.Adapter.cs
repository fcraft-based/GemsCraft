...
namespace GemsCraft.Display.ConfigGUI.GUI
{
    ...
    partial class MainForm
    {
        ...
        private void LoadConfig()
        {
            ...
            AddChangeHandler(SectionClasses.CpeConfig, SomethingChanged);
            ...
            AddChangeHandler(SectionClasses.CpeConfig.bResetTab, SomethingChanged);
            ...
            SectionClasses.CpeConfig.bResetTab.Click += bResetTab_Click;
        ...
        {
            if (Display.ConfigGUI.GUI.MainForm.Worlds.Count > 0) Display.ConfigGUI.GUI.MainForm.Worlds.Clear();
            ...
            try
            {
                ...
                using (LogRecorder logRecorder = new LogRecorder())
                {
                    foreach (XElement el in root.Elements("World"))
                    {
                        try
                        {
                            Display.ConfigGUI.GUI.MainForm.Worlds.Add(new WorldListEntry(el));
                        }
                        catch (Exception ex)
                        {
                ...
                {
                    foreach (WorldListEntry world in Display.ConfigGUI.GUI.MainForm.Worlds)
                    {
            ...
            Display.ConfigGUI.GUI.MainForm.Worlds.ListChanged += SomethingChanged;
        }
        ...
        private void ApplyTabGeneral()
        {
            ...
            Display.ConfigGUI.GUI.MainForm._instance.CheckMaxPlayersPerWorldValue();
            ...
            Display.ConfigGUI.GUI.MainForm.FillRankList(SectionClasses.GeneralConfig.cDefaultRank, "(lowest rank)");
        ...
        private void ApplyTabWorlds()
        {
            if (_rankNameList == null)
            {
                ...
                {
                    _rankNameList.Add(Display.ConfigGUI.GUI.MainForm.ToComboBoxOption(rank));
                }
                ...
                LoadWorldList();
                SectionClasses.WorldConfig.dgvWorlds.DataSource = Display.ConfigGUI.GUI.MainForm.Worlds;
            ...
            else
            {
                ...
                Display.ConfigGUI.GUI.MainForm.Worlds.ResetBindings();
                //dgvWorlds.DataSource = worlds;
            }

            Display.ConfigGUI.GUI.MainForm.FillRankList(SectionClasses.WorldConfig.cDefaultBuildRank, "(default rank)");
        ...
        private void ApplyTabSecurity()
        {
            ...
            Display.ConfigGUI.GUI.MainForm.FillRankList(SectionClasses.SecurityConfig.cPatrolledRank, "(default rank)");
            ...
            Display.ConfigGUI.GUI.MainForm.FillRankList(SectionClasses.SecurityConfig.cBlockDBAutoEnableRank, "(default rank)");

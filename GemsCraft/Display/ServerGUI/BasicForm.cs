...
namespace GemsCraft.Display.ServerGUI
{
    ...
    public sealed partial class BasicForm : Form
    {
        ...
        {
            Shutdown((ShutdownReason) ShutdownReason.FailedToStart, Server.HasArg(ArgKey.ExitOnCrash));
        }
        ...
        protected override void OnFormClosing(FormClosingEventArgs e)
        {
            ...
            {
                Shutdown((ShutdownReason) ShutdownReason.ProcessClosing, true);
                e.Cancel = true;
            }
            else
            {
            ...
            try
            {
                ...
                switch (results)
                {
                    ...
                    case "shutdown":
                        ...
                        Shutdown((ShutdownReason) ShutdownReason.ShuttingDown, true);
                        bVoice.ForeColor = System.Drawing.Color.Black;
                        results = "";
                        engine.RecognizeAsyncStop();
                        engine.Dispose();
